...
// 어떻게 사용하고 원리는 무엇인가요?
function 로그인정보({ 회원등급 = "Gold", 글쓰기 = ture, 글읽기 = ture, 채널관리 = ture, 백업 = "1주일 이내 가능", 소셜로그인여부 = true }) {
  console.log("...함수 기능...");
...
left four = { one, two, three } // {one: undefined, two: undefined, three: undefined}
// 이렇게 사용할 수 있게 된 것이 최근
